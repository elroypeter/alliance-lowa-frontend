...
import { saveNewsTranslation, newTranslation, editTranslation, deleteNewsTranslation, updateNewsTranslation } from '../store/NewsDetails.slice';

export default function NewsTranslation() {
    const dispatch = useDispatch();
    const { langs } = useSelector((state) => state.language);
    const { details, isLoading, isModalOpen, isModalEdit, isTranslation } = useSelector((state) => state.newsDetails);
            ...
            <div className="col-12">
                <div className="card">
                    <div className="card-header d-flex justify-content-between align-items-center bg-transparent py-3">
                        <h6 className="m-0 fw-bold">Blog News Translations</h6>
                        <div className="col-auto d-flex w-sm-100 mt-2 mt-sm-0">
                            ...
                            <NewsForm
                                ...
                                updateNews={() => {
                                    dispatch(updateNewsTranslation({ id: state.form.fields.id, data: state.form.fields }));
                                }}
                                saveNews={() => {
